...
function [] = main_DHondt_2023_3seg_metabolicModel()
    ...
    Setting = { {1, 'Umberger2010', {1},  {false}, 1.33, 'metabolicModel', 0},...       %1   Quasi-random
                {1, 'Umberger2010', {1},  {false}, 1.33, 'metabolicModel', 1},...       %2   Quasi-random
                {1, 'Umberger2010', {2, 'OCP\IK_Guess_Full_GC.mot'}, {false}, 1.33, 'metabolicModel', 1},... %3  Data informed from Falisse,s model
                {1, 'Umberger2010', {2, 'PredSimResults\DHondt_2023_3seg_1strengthMF_MS_back\_0hipAssistance\DHondt_2023_3seg_v2.mot'}, {false}, 1.33, 'metabolicModel', 1},... %4 Sub Optimal solution at the closest level of strength
                {1, 'Umberger2010', {2, 'PredSimResults\DHondt_2023_3seg_1strength\DHondt_2023_3seg_v2.mot'}, {false}, 1.33, 'metabolicModel', 1},...                           %5 Optimal Solution at the closest level of strength
                {1, 'Uchida2016'  , {1},  {false}, 1.33, 'metabolicModel', 0},...       %6   Quasi-random
                {1, 'Uchida2016'  , {1},  {false}, 1.33, 'metabolicModel', 1},...       %7   Quasi-random
                {1, 'Uchida2016'  , {2, 'OCP\IK_Guess_Full_GC.mot'}, {false}, 1.33, 'metabolicModel', 1},... %8  Data informed from Falisse s model
                {1, 'Uchida2016'  , {2, 'PredSimResults\DHondt_2023_3seg_1strengthMF_MS_back\_0hipAssistance\DHondt_2023_3seg_v2.mot'}, {false}, 1.33, 'metabolicModel', 1},... %9 Sub Optimal solution at the closest level of strength
                {1, 'Uchida2016'  , {2, 'PredSimResults\DHondt_2023_3seg_1strength\DHondt_2023_3seg_v2.mot'}, {false}, 1.33, 'metabolicModel', 1},...                           %10 Optimal Solution at the closest level of strength
